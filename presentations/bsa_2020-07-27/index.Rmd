...
## (Very brief) introduction to the biogeography of Japan
...
- Date with 26 fossil calibration points (Testo and Sundue 2016) using treePL (Smith and O'Meara 2012)
...
- `r nrow(trait_summary)` morphological traits mostly used for ID (Ebihara and Nitta 2019)
