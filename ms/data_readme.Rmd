...
- results.zip: Selected analysis results. Files include:
  ...
  - japan_ferns_tree_dated.tre: Maximim-likelihood, ultrametric (dated) phylogeny of native, non-hybrid ferns in Japan
...
available at https://github.com/joelnitta/japan_ferns_biogeo, in particular
https://github.com/joelnitta/japan_ferns_biogeo/blob/main/R/process_raw_data.R.
...
estimated range with <0.05 movement cost was included.
...
script at https://github.com/joelnitta/japan_ferns_biogeo/blob/main/R/geocode.R
...
# Check that no data are missing
assert(japan_ferns_biodiv_dryad, not_na, everything(), success_fun = success_logical)
```
...
in Japan. Biodiversity metrics calculated as described in Nitta et al. 2021. A
single outlier grid-cell with extremely low taxon richness and extremely high %
apomictic taxa was excluded. Climatic (temperature and preciptation) variables
calculated as described for japan_climate.gpkg. Data used for spatial models
in Nitta et al. 2021.
...
Japan in newick format. Tree dated using treePL v1.0 [@Smith2012] with `r
n_fossil_points` fossil calibration points after @Testo2016a. Values at nodes
are bootstrap support values calculated using 1000 replicates of ultrafast
bootstrap [@Nguyen2015].
