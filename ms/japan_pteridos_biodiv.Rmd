...
```{r mpd, fig.asp = 2.0, fig.cap = "Standard effect size (SES) of mean phylogenetic distance (MPD) of: a) pteridophytes, b) ferns, c) ferns analyzed separately north and south of 30.1 degrees latitude. All datasets are native taxa of Japan excluding hybrids."}
...
```{r mntd, fig.asp = 2.0, fig.cap = "Standard effect size (SES) of mean nearest taxon distance (MNTD) of: a) pteridophytes, b) ferns, c) ferns analyzed separately north and south of 30.1 degrees latitude. All datasets are native taxa of Japan excluding hybrids."}
a <- make_diversity_map(
    div_data = alpha_div_pteridos, 
    world_map = world_map, 
    occ_data = occ_data_pteridos, 
