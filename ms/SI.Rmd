...
**`r s_figure("tree")`**. Time tree of native Japanese ferns and lycophytes, excluding hybrids. Points at nodes indicate bootstrap support. Scalebar 100 my.
...
plot_genus <- function(part, genus_select) {
  ...
  ggplot() +
    geom_sf(data = japan, fill = "grey90", color = "black", lwd = 0.25) +
    geom_sf(data = genus_abun, aes(fill = richness), color = "transparent", alpha = 0.8) +
    annotate(
      geom="richtext", y = Inf, x = -Inf, 
