...
**`r s_figure("grain-size")`**. Effect of grain size on sampling redundancy. (a), Percent of grid cells with redundancy > 0.5 by grain size (side length of square grid cells set to 10 km, 20 km, 30 km, or 40 km). (b), Percent of grid cells with redundancy = 0 by grain size. (c), Distribution of redundancy values by grain size. There is a sudden improvement in redundancy values from 10 km to 20 km, but less improvement as grain size is increased beyond 20 km.
