...
All spatial models were significant relative to null models without any fixed effects. The effect of temperature dominated in most models, with only SES of PD showing a stronger effect of precipitation seasonality. Models fit using % apomictic taxa instead of temperature had lower cAIC, indicating a better fit. Biodiversity metrics with a genetic component (SES of PD, SES of RPD) each had a large, negative relationship with % apomictic taxa.
