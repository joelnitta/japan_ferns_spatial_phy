...
Our data include all ferns known to natively occur within the boundaries of Japan . 
...
Initial inspection of the biodiversity and environmental data showed a single outlier in % apomictic taxa due to extremely low species richness (Appendix S2), so that grid-cell and one grid-cell lacking environmental data were excluded from modeling analyses.
...
Data files needed to run the analysis and selected results files are available from Figshare at http://doi.org/FIXME:ADD_DOI_HERE_WHEN_ASSIGNED.
