...
The ferns of Japan include `r total_fern_taxa` native, non-hybrid taxa (including species and varieties) and hundreds of hybrids [@Ebihara2019b].
The availability of detailed distribution data [distribution maps at the ca. 10 km scale for nearly all species\; @Ebihara2016b; @Ebihara2017], trait data [multiple quantitative and qualitative traits compiled for identification of nearly all species\; @Ebihara2019b], and DNA sequences for > 97% of species [@Ebihara2010; @Ebihara2019b\; all coverage statistics exclude hybrids] make the ferns of Japan an ideal system for investigating the relationships between, and drivers of, multiple dimensions of biodiversity.
...
One element of biodiversity that we did not consider here is hybrids (nothotaxa).
