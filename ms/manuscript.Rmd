...
**`r figure("raw-diversity")`**. Raw (observed) biodiversity metrics of the ferns of Japan. (A) Raw taxonomic diversity (B). Raw phylogenetic diversity. (C) Raw functional diversity. For (B) and (C), raw branchlengths were transformed to relative values by dividing each branchlength by the sum of all branchlengths.
