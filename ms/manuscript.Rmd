...
All measures of biodiversity and CANAPE were carried out using the `r pack("canaper")` package (https://github.com/joelnitta/canaper), which calculates observed values of biodiversity using functions in the `r pack("phyloregion")` package [@Daru2020a] and randomizations using the `r pack("picante")` package [@Kembel2010].
