...
Characterizing biodiversity is important for two reasons: to understand the processes generating it, and to conserve it.

Most past studies of biodiversity only focus on one dimension: richness.

Recently tools and data are available to analyze additional dimensions (in particular phylogenetic dimensions). Furthermore, better ways to characterize biological regions ("bioregions") are also available, rather than simply using expert opinion or other ad-hoc characterizations.

Incorporating two frameworks---the categorization of areas into phyloregions with analysis of over/under dispersion of biodiversity---can provide particularly powerful insights into the processes structuring biodiversity and suggest conservation priorities.
