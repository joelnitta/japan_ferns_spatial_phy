...
One particularly valuable characteristic of the Japanese fern flora is the availability of data on reproductive mode (known for `r repro_count$known$total` of `r repro_count$known$total + repro_count$unknown$total` native pteridophyte taxa excluding hybrids [`r repro_count$known$percent`]) [@Ebihara2019b].
...
A similar argument has been made to assert that areas with seasonal monsoons are linked to increased rates of apomictic ferns [@Liu2012; @Tanaka2014; @Picard2021], but in Japan, although the areas including high percentages of apomictic taxa are monsoonal, the degree of seasonal water limitation does not approach that of a desert.
...
The authors thank Members of the Iwasaki Lab at the University of Tokyo for providing comments that improved the manuscript.
Shawn Laffan provided advice about CANAPE.
This study was supported by JSPS KAKENHI Grant Number 16H06279.
...
**Note to reviewers**: the Figshare DOI will not be accessible until the paper is accepted. During review, the data can be accessed from this link: https://figshare.com/s/de3d5a70e118208e56c5.
