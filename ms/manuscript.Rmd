...
Points were projected into the Japanese Geodetic Datum 2000 (JGD 2000), which was also used for all further geographic analyses.
...
The high protection status of grid-cells with high PE may be due to an emphasis on conserving rare, endemic plant and animal species in Japanese southern islands such as Iriomote and Amami [@kankyosho2021b], which include many grid-cells with high PE (`r s_figure("protected-map")`d).
