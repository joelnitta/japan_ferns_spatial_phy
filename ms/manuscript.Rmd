...
The vast majority of grid-cells fell to a subset of these clusters: using taxonomic distances, they include Cluster 1 (Hokkaido and northern Honshu), Cluster 2 (southern Honshu), Cluster 3 (Ryukyu Islands, excluding Yakushima), and Cluster 4 (Ogasawara Islands) (`r figure("bioregions")`A). 
Phylogenetic distances produced similar results, but the Ryukyu and Ogasawara Islands merged into a single cluster (`r figure("bioregions")`B). 
