...
Our study integrates diverse, thoroughly collected datasets to characterize the spatial biodiversity of Japanese ferns and gain insight into the processes generating these patterns. We end by summarizing some caveats that must be kept in mind when interpreting our results, while also suggesting avenues for future research.
