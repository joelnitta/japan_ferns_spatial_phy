...
This approach reflects the idea that the amount of area with a given climate regime enclosing each grid cell may influence species richness of that cell [@Fahrig2013], and that simply using raw island areas would not be appropriate in this context as there are just four very large islands with many much smaller ones located close by.
...
The comprehensive molecular sampling of sporophytes in Japan makes this area ideal for conducting high-throughput DNA barcoding analyses to compare patterns of biodiversity between life stages in ferns across large spatial scales.
