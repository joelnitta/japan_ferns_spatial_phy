...
First, the data include species collected over a wide time period, so they do not necessarily represent the current distribution of ferns in Japan. 
...
Methods for calculating PD would need to be modified to take into account multiple lineages contributing to a terminal taxon.
...
**`r table("traits-used")`**. Fern traits used in this study. Letters in parentheses indicate trait type: b, binary; c, continuous; q, qualitative. Qualitative traits were coded as binary for analysis (see Methods).
